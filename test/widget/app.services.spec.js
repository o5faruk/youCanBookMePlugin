describe('Unit: youCanBookMePluginWidget: Services', function () {
    beforeEach(module('youCanBookMePluginWidget'));
  ...
  describe('Unit : DataStore Factory', function () {
    ...
    beforeEach(module('youCanBookMePluginWidget', function ($provide) {
